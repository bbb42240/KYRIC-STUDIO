 ...
 */
  ! function(e) {
    ...
    r.prototype.getSuffix = function(t, i) {
        ...
        t.width(s), t.height(r + this.settings.heightAdj), t.css("top", e), t.css("left", i);
        var o = this.imgFromEntry(t);
        if (null !== o) {
            o.css("width", s), o.css("height", n), o.css("margin-left", -s / 2), o.css("margin-top", (-n / 2) - this.settings.heightAdj/2);
            var a = o.attr("src"),
        ...
        if (e = this.prepareBuildingRow(t), t && "hide" === n.lastRow && -1 === e) this.clearBuildingRow();
            ...
            this.galleryHeightToSet = this.offY + this.buildingRow.height + this.border + this.settings.heightAdj, this.setGalleryTempHeight(this.galleryHeightToSet + this.getSpinnerHeight()), (!t || this.buildingRow.height <= n.rowHeight && e) && (this.offY += this.buildingRow.height + n.margins + this.settings.heightAdj, this.rows += 1, this.clearBuildingRow(), this.settings.triggerEvent.call(this, "jg.rowflush"))
        }
    };
    var i = 0;
