...
<body <?php body_class(); ?>>
	<!-- Header -->
	<div class="header-container page pad-40">
		<nav class="nav d-flex flex-wrap">
			<a href="<?php echo get_home_url(); ?>" class="nav-brand width-40"><img src="<?php echo get_theme_file_uri('assets/images/kyric_logo.svg'); ?>" alt=""></a>
			<div class="navmenu width-60 d-flex ai-center jc-end">
				<ul class="d-flex fz-16">
					<li><a href="<?php echo get_page_link(5); ?>">Commercial</a></li>
					<li><a href="<?php echo get_page_link(10); ?>">Commercial Film</a></li>
					<li><a href="<?php echo get_page_link(12); ?>">Cosmetic</a></li>
					<li><a href="<?php echo get_page_link(16); ?>">Food</a></li>
					<li><a href="<?php echo get_page_link(18); ?>">Interior</a></li>
				</ul>
			</div>
		...
		<div class="contact-btn d-flex single">
			<a href="<?php echo get_page_link(20); ?>">
				<span>contact<i class="icon-letter"></i></span>
			</a>
		</div>
		<a href="#" class="scrollTop-btn single fade fadeOut" id="toTop-btn">
