...
/**
 * Template Name: Commercial Film 商業動態
 * 
 * 
 * 
 */
...
<section class="gallery">
    <div class="cate-link" href="#">
        <h2 class="cate-title">COMMERCIAL FILM</h2>
    </div>
    <div id="filmGallery" class="gallery-content">
        <?php
        $film_loop = new WP_Query(array(
            'post_type' => 'commercial-film',
            'order' => 'ASC',
            'cat' => 4, //category: 商業攝影 -> ID:3、商業動態 -> ID:4、化妝品攝影 -> ID:5、美食攝影 -> ID:6、空間攝影 -> ID:7
            'post_per_page' => '-1'
        ));
